...
const LearnMain: React.FC = () => {
  ...
  return (
    <main className={classes.hero}>
      {content.map((item, index) => <Section key={index} headingSecondary={item.secondaryHeading} headingTertiary={item.primaryHeading} content={item.mainContent}/>)}
    </main>
  );
};
